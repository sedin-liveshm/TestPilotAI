...
name: "PilotAI"
description: "AI-native, transparent no-code web test automation platform."
colors:
  primary: "#431407"
  secondary: "#F97316"
  accent: "#F97316"
...
Tags: automation, testing, ai, bento, dashboard.
## Overview
PilotAI is designed for creating, executing, and analyzing AI-native web tests. Key features include a test builder, test execution runs, and detailed reporting. It is suitable for QA engineering and developer testing platforms.

PilotAI Automation Plans. Streamline testing with smart AI workflows. Optimize your QA process and harness data for robust outcomes. Get Started. Expand testing capabilities.
## Composition
Use the attached HTML reference as the source of truth. Preserve the visible hierarchy, first-screen composition, section rhythm, density, and interaction tone before adapting copy or content.
Key visible headings include: Streamline testing with smart AI workflows.; Refined test assets; Frameworks.; Inter Sans; Discover crafted automation patterns..
## Colors
